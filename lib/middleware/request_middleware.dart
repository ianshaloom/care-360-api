...
Middleware requestServiceMiddleware() {
  return (handler) {
    return (context) async {
      ...
      final requestService = RequestService(firestoreHelper, messagingHelper);

      // Inject the service into the request context
      final newContext = context.provide<RequestService>(() => requestService);
